...
#ifndef SOUTHBRIDGE_INTEL_X58_CHIP_H
#define SOUTHBRIDGE_INTEL_X58_CHIP_H

struct southbridge_intel_x58_config {
	/**
...
extern struct chip_operations southbridge_intel_x58_ops;

#endif				/* SOUTHBRIDGE_INTEL_X58_CHIP_H */

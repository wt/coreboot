...
struct chip_operations northbridge_intel_core_i7_ops = {
	CHIP_NAME("Intel Core i7 Northbridge")
...
struct chip_operations northbridge_intel_core_i7_root_complex_ops = {
	CHIP_NAME("Intel Core i7 Root Complex")
